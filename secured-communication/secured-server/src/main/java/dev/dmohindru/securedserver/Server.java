package dev.dmohindru.securedserver;
...
//                       "public".toCharArray() );
    clientKeyStore.load( Server.class.getClassLoader().getResourceAsStream("client.public"),
            "public".toCharArray() );
  }
...
//                        passphrase.toCharArray() );
    serverKeyStore.load( Server.class.getClassLoader().getResourceAsStream("server.private"),
            passphrase.toCharArray() );
  }
