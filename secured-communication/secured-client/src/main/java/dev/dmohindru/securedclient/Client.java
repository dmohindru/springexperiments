package dev.dmohindru.securedclient;
...
//                "public".toCharArray() );
        serverKeyStore.load( Client.class.getClassLoader().getResourceAsStream("server.public"),
                "public".toCharArray() );
    }
...
//                passphrase.toCharArray() );
        clientKeyStore.load( Client.class.getClassLoader().getResourceAsStream("client.private"),
                passphrase.toCharArray() );
    }
